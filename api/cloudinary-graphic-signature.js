...
function getPublicIdFromFilename(filename) {
  ...
  const safeBase = sanitizePublicId(base) || 'graphic';
...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    const uploadFolder = folder && String(folder).trim() ? String(folder).trim() : DEFAULT_GRAPHICS_FOLDER;
    ...
    // Exclude file/cloud_name/api_key/resource_type from signature.
