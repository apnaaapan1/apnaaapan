...
const HeroSection = () => {
  return (
    <section className="relative min-h-[60vh] md:min-h-[70vh] lg:min-h-[80vh] flex items-center justify-center bg-[#EFE7D5] px-4 sm:px-6 lg:px-8 py-6 sm:py-8 md:py-10 overflow-hidden">
      {/* Main Content Container - Adjusted size to match design */}
      <div className="relative z-10 max-w-6xl mx-auto w-full">
        {/* Hero Card - Properly sized as in design image */}
        <div className="relative bg-[#faf8f3] rounded-xl sm:rounded-2xl md:rounded-3xl p-6 sm:p-8 md:p-12 lg:p-16 shadow-2xl overflow-hidden min-h-[50vh] sm:min-h-[45vh] md:min-h-[50vh] flex items-center justify-center">
          ...
          <div className="relative z-10 text-center max-w-5xl mx-auto px-4 sm:px-4">
            ...
            <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-serif leading-tight mb-6 sm:mb-8">
              ...
              <span className="bg-gradient-to-r from-orange-500 via-orange-400 to-yellow-400 bg-clip-text text-transparent font-bold block text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl md:whitespace-nowrap overflow-visible">
